...
public class Products extends Fragment implements MOPView {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        dotsLayout = (LinearLayout) view.findViewById(R.id.layout2);
        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_products);
        if (isAdded()) {
            presenter = new MOPPresenter(new MOPModel(), this, "3");
        ...
        recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                if (dx > 0) {
                   /* int visibalcount = manager.getChildCount();
